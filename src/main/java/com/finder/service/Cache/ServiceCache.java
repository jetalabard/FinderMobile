...
public class ServiceCache implements IServiceCache
{
    ...
    public User getIdentity() {
        User user =null;
        String JsonList = SharedPreferences.getDataFromSharedPreferences(SharedPreferencesTags.PREF_USER);
        if(!JsonList.isEmpty()){
    ...
    {
        SharedPreferences.updateSharedPreferences(SharedPreferencesTags.PREF_USER,gson.toJson(user));
    }
